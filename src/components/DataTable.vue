        ...
        <tbody class="divide-y divide-gray-200 bg-white">
          <template v-for="(item, i) of data" :key="item.id">
            <tr>
              ...
              <td
                :title="item.name"
                class="whitespace-nowrap text-ellipsis break-all overflow-hidden py-2 pl-4 pr-3 text-xs font-medium text-gray-900 max-w-60"
              >
                {{ item.name }}
              </td>
              <td
                class="whitespace-nowrap text-ellipsis break-all overflow-hidden px-3 py-2 text-xs text-gray-500"
              >
