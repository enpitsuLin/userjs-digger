...
type NotificationFn = {
    (text: string, title?: string, image?: string, onclick?: () => void): NotificationControl;
...
type XhrRequest<TContext = object> = {
     ...
     */
    responseType?: 'arraybuffer' | 'blob' | 'json' | 'stream' | 'document' | 'text';
...
type MonkeyWindow = Window & {
     ...
     */
    GM_addValueChangeListener: (name: string, callback: <T = unknown>(name: string, oldValue?: T, newValue?: T, remote?: boolean) => void) => string;
    /**
     ...
     */
    GM_registerMenuCommand: <T extends MouseEvent | KeyboardEvent>(caption: string, onClick: (event: T) => void) => string;
    /**
...
declare const GM: {
    ...
    addElement: {
        ...
        <K_1 extends keyof HTMLElementTagNameMap>(parentNode: Element | Node | ShadowRoot, tagName: K_1, attributes?: Partial<HTMLElementTagNameMap[K_1]> | undefined): HTMLElementTagNameMap[K_1];
        (parentNode: Element | Node | ShadowRoot, tagName: string, attributes?: Partial<HTMLElement> | undefined): HTMLElement;
    };
    registerMenuCommand: <T extends MouseEvent | KeyboardEvent>(caption: string, onClick: (event: T) => void) => string;
    info: ScriptInfo;
    cookie: CookieFn;
    notification: {
 ...
 * @available tampermonkey
 */
declare const GM_cookie: CookieFn;
/**
 ...
 * @see https://violentmonkey.github.io/api/gm/#gm_addvaluechangelistener
 */
declare const GM_addValueChangeListener: (name: string, callback: <T = unknown>(name: string, oldValue?: T | undefined, newValue?: T | undefined, remote?: boolean | undefined) => void) => string;
/**
 ...
 * @see https://violentmonkey.github.io/api/gm/#gm_registermenucommand
 */
declare const GM_registerMenuCommand: <T extends MouseEvent | KeyboardEvent>(caption: string, onClick: (event: T) => void) => string;
/**
 ...
 * @see https://violentmonkey.github.io/api/gm/#gm_xmlhttprequest
 */
declare const GM_xmlhttpRequest: <TContext>(details: XhrRequest<TContext>) => {
    abort(): void;
};
/**
...
export { DownloadRequest, GM, GM_addElement, GM_addStyle, GM_addValueChangeListener, GM_cookie, GM_deleteValue, GM_download, GM_getResourceText, GM_getResourceURL, GM_getTab, GM_getTabs, GM_getValue, GM_info, GM_listValues, GM_log, GM_notification, GM_openInTab, GM_registerMenuCommand, GM_removeValueChangeListener, GM_saveTab, GM_setClipboard, GM_setValue, GM_unregisterMenuCommand, GM_webRequest, GM_xmlhttpRequest, MonkeyWindow, NotificationDetails, OpenInTabDetails, XhrRequest, monkeyWindow, unsafeWindow };
