...
import { Fn, MaybeRef, MaybeComputedRef, Awaitable, ConfigurableEventFilter, ConfigurableFlush, RemovableRef, EventHookOn, Arrayable, MaybeReadonlyRef, UseIntervalFnOptions, Pausable, UseTimeoutFnOptions } from '@vueuse/shared';
 ...
 * @param options
 */
declare function useCssVar(prop: MaybeComputedRef<string>, target?: MaybeElementRef, options?: UseCssVarOptions): vue_demi.Ref<string>;
 ...
 */
declare function useCycleList<T>(list: MaybeComputedRef<T[]>, options?: UseCycleListOptions<T>): UseCycleListReturn<T>;
 ...
 * @param options
 */
declare function executeTransition<T extends number | number[]>(source: Ref<T>, from: MaybeRef<T>, to: MaybeRef<T>, options?: TransitionOptions): PromiseLike<void>;
declare function useTransition(source: MaybeComputedRef<number>, options?: UseTransitionOptions): ComputedRef<number>;
declare function useTransition<T extends MaybeComputedRef<number>[]>(source: [...T], options?: UseTransitionOptions): ComputedRef<{
    [K in keyof T]: number;
}>;
declare function useTransition<T extends MaybeComputedRef<number[]>>(source: T, options?: UseTransitionOptions): ComputedRef<number[]>;
