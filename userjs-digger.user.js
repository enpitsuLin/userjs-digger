...
(function (vue, vueI18n, psl) {
  ...
  const _hoisted_2$5 = { class: "overflow-hidden shadow-sm ring-1 ring-black ring-opacity-5" };
  const _hoisted_3$4 = { class: "min-w-full divide-y divide-$ud-border-secondary" };
  const _hoisted_4$4 = { class: "bg-$ud-bg-secondary sticky select-none" };
  const _hoisted_5$4 = {
    scope: "col",
    class: "relative p-2"
  };
  ...
  const _hoisted_8$3 = { class: "inline-flex items-center" };
  const _hoisted_9$2 = { class: "relative ml-0.5" };
  const _hoisted_10$2 = { class: "inline-flex items-center" };
  const _hoisted_11$2 = { class: "relative ml-0.5" };
  const _hoisted_12$1 = {
    scope: "col",
    class: "relative py-2 pl-3 pr-4"
  };
  const _hoisted_13$1 = { class: "sr-only" };
  const _hoisted_14$1 = { class: "divide-y divide-$ud-border bg-$ud-bg" };
  const _hoisted_15$1 = ["onClick"];
  const _hoisted_16$1 = ["title"];
  const _hoisted_17$1 = ["href"];
  const _hoisted_18$1 = { class: "break-all truncate px-3 py-2 text-xs text-$ud-text-secondary" };
  const _hoisted_19$1 = { class: "break-all truncate px-3 py-2 text-xs text-$ud-text-secondary" };
  const _hoisted_20$1 = { class: "relative truncate py-2 pl-3 pr-4 text-right text-xs font-medium" };
  ...
  const _hoisted_25 = { class: "mx-2" };
  const _hoisted_26 = { class: "text-xs grid grid-cols-6 gap-y-2" };
  const _hoisted_27 = { class: "font-semibold" };
  const _hoisted_28 = { class: "text-$ud-text" };
  const _hoisted_29 = { class: "font-semibold" };
  const _hoisted_30 = { class: "text-$ud-text" };
  const _hoisted_31 = { class: "font-semibold" };
  const _hoisted_32 = { class: "text-$ud-text" };
  const _hoisted_33 = { class: "font-semibold" };
  const _hoisted_34 = { class: "col-span-5 text-$ud-text" };
  const _hoisted_35 = ["href"];
  const _hoisted_36 = { class: "font-semibold" };
  const _hoisted_37 = { class: "col-span-5 text-$ud-text" };
  const _hoisted_38 = {
    key: 0,
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$6, [
          vue.createElementVNode("div", _hoisted_2$5, [
            vue.createElementVNode("table", _hoisted_3$4, [
              vue.createElementVNode("thead", _hoisted_4$4, [
                vue.createElementVNode("tr", null, [
                  vue.createElementVNode("th", _hoisted_5$4, [
                    vue.createElementVNode("span", _hoisted_6$4, vue.toDisplayString(vue.unref(t)("table.toggle-expand")), 1)
                  ]),
                  vue.createElementVNode("th", _hoisted_7$4, vue.toDisplayString(vue.unref(t)("table.title")), 1),
                  ...
                  vue.createElementVNode("th", _hoisted_12$1, [
                    vue.createElementVNode("span", _hoisted_13$1, vue.toDisplayString(vue.unref(t)("table.install")), 1)
                  ])
                ])
              ]),
              vue.createElementVNode("tbody", _hoisted_14$1, [
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(sortedData), (item, i) => {
                    ...
                    vue.createElementVNode("tr", null, [
                      ...
                      vue.createElementVNode("td", {
                        ...
                        vue.createElementVNode("a", {
                          href: item.url,
                          target: "_blank"
                        }, vue.toDisplayString(item.name), 9, _hoisted_17$1)
                      ], 8, _hoisted_16$1),
                      vue.createElementVNode("td", _hoisted_18$1, vue.toDisplayString(item.daily_installs), 1),
                      vue.createElementVNode("td", _hoisted_19$1, vue.toDisplayString(formatTimeAgoWithI18n(new Date(item.code_updated_at))), 1),
                      vue.createElementVNode("td", _hoisted_20$1, [
                        vue.createElementVNode("a", {
                          href: item.code_url,
                          target: "_blank",
                          ...
                          vue.createElementVNode("span", _hoisted_22, ", " + vue.toDisplayString(item.name), 1)
                        ], 8, _hoisted_21)
                      ])
                    ]),
                    vue.unref(expanded)[i] ? (vue.openBlock(), vue.createElementBlock("tr", _hoisted_23, [
                      vue.createElementVNode("td", _hoisted_24, [
                        vue.createElementVNode("div", _hoisted_25, [
                          vue.createElementVNode("dl", _hoisted_26, [
                            vue.createElementVNode("dt", _hoisted_27, vue.toDisplayString(vue.unref(t)("table.version")), 1),
                            vue.createElementVNode("dd", _hoisted_28, vue.toDisplayString(item.version), 1),
                            vue.createElementVNode("dt", _hoisted_29, vue.toDisplayString(vue.unref(t)("table.score")), 1),
                            vue.createElementVNode("dd", _hoisted_30, vue.toDisplayString(item.fan_score), 1),
                            vue.createElementVNode("dt", _hoisted_31, vue.toDisplayString(vue.unref(t)("table.total-installs")), 1),
                            vue.createElementVNode("dd", _hoisted_32, vue.toDisplayString(item.total_installs.toLocaleString()), 1),
                            vue.createElementVNode("dt", _hoisted_33, vue.toDisplayString(vue.unref(t)("table.authors")), 1),
                            vue.createElementVNode("dd", _hoisted_34, [
                              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(item.users, (user) => {
                                ...
                                }, vue.toDisplayString(user.name), 9, _hoisted_35);
                              }), 128))
                            ]),
                            vue.createElementVNode("dt", _hoisted_36, vue.toDisplayString(vue.unref(t)("table.description")), 1),
                            vue.createElementVNode("dd", _hoisted_37, vue.toDisplayString(item.description), 1)
                          ])
                        ])
                      ])
            ...
            __props.data.length === 0 ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_38, vue.toDisplayString(vue.unref(t)("table.empty")), 1)) : vue.createCommentVNode("", true)
          ])
        ]);
      };
    }
  ...
  const _hoisted_8$1 = { class: "text-sm text-$ud-text-secondary text-xs" };
          ...
          vue.createElementVNode("ul", _hoisted_4$1, [
            vue.createElementVNode("li", _hoisted_5$1, [
              vue.createElementVNode("div", _hoisted_6$1, [
                ...
                vue.createElementVNode("p", _hoisted_8$1, vue.toDisplayString(vue.unref(t)("language-desc")), 1)
              ]),
            ...
            vue.createElementVNode("li", _hoisted_17, [
              vue.createElementVNode("div", _hoisted_18, [
                ...
                vue.createElementVNode("p", _hoisted_20, vue.toDisplayString(vue.unref(t)("filter-desc")), 1)
              ]),
  ...
  function useDataList() {
    ...
    const data = vue.computed(() => {
      ...
      return (((_a2 = greasyfork.value) == null ? void 0 : _a2.concat(
        ...
        (item) => settings2.value.filter.every((keywords) => !item.name.includes(keywords))
      );
    });
    return data;
  }
  const _hoisted_1 = { class: "p-2 text-sm truncate" };
  const _hoisted_2 = { class: "rounded-full mx-1 px-2 py-0.25 text-xs bg-indigo-500 text-white" };
  const _hoisted_3 = ["title"];
  const _hoisted_4 = /* @__PURE__ */ vue.createElementVNode("div", { class: "i-carbon:settings-adjust" }, null, -1);
  const _hoisted_5 = [
    _hoisted_4
  ];
  const _hoisted_6 = /* @__PURE__ */ vue.createElementVNode("div", { class: "i-carbon-close" }, null, -1);
  const _hoisted_7 = [
    _hoisted_6
  ];
  const _hoisted_8 = {
        ...
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
          ...
          vue.unref(enable) ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
            ...
            vue.createElementVNode("div", {
                ...
                vue.createElementVNode("span", _hoisted_1, [
                  vue.createVNode(_component_i18n_t, { keypath: "tip" }, {
                    ...
                    host: vue.withCtx(() => [
                      ...
                      }, vue.toDisplayString(vue.unref(pagePsl)), 9, _hoisted_3)
                    ]),
                    _: 1
                  })
                ]),
              ...
              vue.unref(showTable) ? (vue.openBlock(), vue.createElementBlock("section", _hoisted_8, [
  ...
  const zh = {
    ...
    "filter-desc": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["过滤标题含有指定内容的用户脚本"]);
    },
    "time-ago": {
      "just-now": (ctx) => {
        const { normalize: _normalize } = ctx;
  ...
  const en = {
    ...
    "filter-desc": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Filter user script with specific content in title"]);
    },
    "time-ago": {
      "just-now": (ctx) => {
        const { normalize: _normalize } = ctx;
